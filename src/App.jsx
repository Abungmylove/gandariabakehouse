    ...
    <div className="min-h-screen bg-brand-bg font-sans text-brand-brown">
      ...
      <div className="bg-brand-brown px-4 py-4 md:px-8 md:py-6 relative z-0">
        ...
        >
          ...
          <h2 className="font-display text-5xl md:text-[6rem] lg:text-[7rem] font-bold text-brand-brown leading-[0.9] tracking-tight uppercase relative z-10">
            Roti <span className="text-brand-red">Homemade</span><br/>
            Terjangkau
          </h2>
          <h3 className="font-display text-2xl md:text-3xl font-bold text-brand-brown mt-4 mb-2">Untuk Semua Momen</h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center max-w-4xl mx-auto px-4 gap-6">
            <p className="text-sm font-bold text-brand-brown/70 max-w-[300px] text-left leading-relaxed">
              Nikmati berbagai pilihan roti dan cookies dengan cita rasa rumahan, dibuat dengan bahan pilihan dan harga yang terjangkau untuk menemani sarapan, berkumpul bersama keluarga, maupun berbagai acara spesial.
            </p>
            <div className="flex flex-col items-end gap-3">
               <span className="text-xs font-black tracking-widest text-brand-brown/50">SEGAR + LEZAT + MANIS</span>
               <button onClick={() => setIsModalOpen(true)} className="bg-brand-brown text-brand-bg px-8 py-3 rounded-full text-xs font-black tracking-widest hover:bg-brand-brown-light transition flex items-center gap-2 uppercase cursor-pointer">
                 Temukan Roti Favoritmu <ArrowRight className="w-4 h-4" />
               </button>
            </div>
          </div>
        </motion.div>
      ...
      <section id="menu" className="section-padding px-4 md:px-8 lg:px-16 text-center max-w-7xl mx-auto">
        <div className="mb-16 relative">
          <span className="bg-brand-red text-white text-[10px] font-bold tracking-widest px-3 py-1 rounded-full uppercase absolute -top-4 left-1/2 -translate-x-1/2">Terfavorit</span>
          <h2 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-tight mt-6">
            Cicipi Menu<br/>Andalan Kami
          </h2>
        </div>

        <div className="flex justify-center gap-8 md:gap-16 mb-20">
          {[
            { name: "PASTRI", color: "bg-brand-tan", img: "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?q=80&w=300&auto=format&fit=crop" },
            { name: "ROTI", color: "bg-brand-red", img: "https://images.unsplash.com/photo-1599599810769-bcde5a160d32?q=80&w=300&auto=format&fit=crop", textClass: "text-brand-red" },
            { name: "COOKIES", color: "bg-brand-yellow", img: "https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?q=80&w=300&auto=format&fit=crop" }
          ].map((cat, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              <h2 className="font-display text-5xl md:text-6xl font-bold uppercase leading-[1.1] mb-8">
                Kami menyediakan produk bakery dengan cita rasa khas rumahan.
              </h2>
              <button onClick={() => setIsModalOpen(true)} className="inline-block border-2 border-white px-6 py-2 rounded-full text-xs font-black tracking-widest hover:bg-white hover:text-brand-red transition uppercase cursor-pointer">
                Pesan Sekarang
              </button>
            </div>
            
            <div className="flex flex-col gap-6">
              <div className="h-64 rounded-[2rem] overflow-hidden border-4 border-white/20 shadow-lg bg-brand-tan">
              ...
              <p className="text-sm font-semibold bg-brand-brown p-6 rounded-[2rem] shadow-lg leading-relaxed text-white">
                Salah satu produk unggulan kami adalah <strong className="text-brand-yellow font-bold">Roti Buaya Pamulang</strong>, yang cocok digunakan sebagai pilihan untuk acara pernikahan maupun acara spesial lainnya. Selain itu, tersedia juga <strong className="text-brand-yellow font-bold">Cookies Homemade</strong> dengan berbagai pilihan rasa yang cocok dinikmati bersama keluarga atau dijadikan bingkisan. Dengan mengutamakan rasa dan kualitas, kami menghadirkan produk bakery yang dapat dinikmati oleh berbagai kalangan.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="catering" className="section-padding px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2 relative">
             ...
             <img src="https://images.unsplash.com/photo-1621236378699-8597faf6a176?q=80&w=800&auto=format&fit=crop" alt="Fresh baked" className="w-full h-[500px] object-cover rounded-[3rem] shadow-xl" />
             <div className="absolute -bottom-6 -right-6 bg-brand-yellow p-6 rounded-[2rem] shadow-lg border-2 border-brand-brown rotate-3 max-w-[200px]">
               ...
               <p className="text-xs font-bold leading-tight">"Roti buayanya luar biasa, sangat berkesan untuk acara pernikahan kami!"</p>
             </div>
          </div>

          <div className="w-full lg:w-1/2">
            <span className="bg-brand-red text-white text-[10px] font-bold tracking-widest px-3 py-1 rounded-full uppercase mb-6 inline-block">Kualitas Utama</span>
            <h2 className="font-display text-5xl font-bold uppercase leading-tight mb-8">
              Dibuat Sepenuh Hati<br/>Dipanggang dengan Cinta
            </h2>
            
            <div className="space-y-6">
              {[
                { title: "Dibuat Segar Setiap Hari", desc: "Dipanggang setiap pagi untuk kesegaran maksimal." },
                { title: "Bahan Pilihan", desc: "Setiap produk dibuat dengan perhatian terhadap kualitas." },
                { title: "Katering Acara Spesial", desc: "Pilihan terbaik untuk pernikahan, rapat, dan kumpul keluarga." }
              ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
             <div>
               ...
               <div className="flex gap-4 items-center bg-white/5 p-4 rounded-2xl max-w-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/60">Jl. SouthCity No.14, Pamulang</p>
                    <p className="text-xs text-white/60 mt-1">Selasa - Minggu | 07:30 - 17:00</p>
                  </div>
               </div>
             </div>
             ...
             <div className="flex flex-col justify-end">
               <div className="bg-brand-bg text-brand-brown p-8 rounded-[2rem] shadow-xl">
                 <h3 className="font-display text-2xl font-bold uppercase mb-4">Dapatkan Promo Menarik</h3>
                 <div className="flex gap-2">
                   <input type="email" placeholder="Alamat email..." className="bg-white border border-brand-brown/20 rounded-full px-4 py-3 flex-1 text-sm outline-none focus:border-brand-brown" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center border-t border-white/10 pt-8 gap-4">
             ...
             <div className="flex gap-6 text-xs font-bold uppercase tracking-widest text-white/60">
               ...
               <a href="#" className="hover:text-brand-yellow transition">Kisah</a>
               <a href="#" className="hover:text-brand-yellow transition">Katering</a>
             </div>
